            ...
            {username ? (
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  className="text-sm text-red-500 hover:text-red-600 cursor-pointer transition-all duration-200 hover:underline hover:scale-105 active:scale-95"
                >
                  Logout
                </button>
              </div>
                  ...
                  {username ? (
                    <div className="space-y-3">
                      ...
                      <button
                        ...
                        className="w-full py-3 px-4 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-all hover:bg-red-600 cursor-pointer transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-md">
                        Logout
                      </button>
                    </div>
                  ) : (
